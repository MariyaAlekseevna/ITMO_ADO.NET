...
namespace ITMO_ADO.NET_Lab1_and_Lab2_DBConnection
{
    public partial class Form1 : Form
    {
        ...
        //                        Initial Catalog=Northwind;Data Source=DESKTOP-IFF626O\SQLEXPRESS";
        public Form1()
        {
            InitializeComponent();
        ...
        static string GetConnectionStringByName(string name) //возвращает значение строки соединения по ее имени//
        {
